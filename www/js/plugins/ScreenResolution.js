...
SceneManager._screenWidth  = Number(Yanfly.Parameters['Screen Width'] || 1280);
SceneManager._screenHeight = Number(Yanfly.Parameters['Screen Height'] || 720);
SceneManager._boxWidth     = Number(Yanfly.Parameters['Screen Width'] || 1280);
SceneManager._boxHeight    = Number(Yanfly.Parameters['Screen Height'] || 720);
